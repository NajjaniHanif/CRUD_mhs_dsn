...
//Fungsi isset() memeriksa apakah suatu variabel ditetapkan, yang berarti harus dideklarasikan dan bukan NULL.
//Fungsi ini mengembalikan nilai true jika variabel ada dan bukan NULL, jika tidak maka akan mengembalikan nilai false.

//PHP $_POST adalah variabel yang digunakan untuk mengumpulkan data formulir setelah mengirimkan formulir HTML. $_POST juga banyak digunakan untuk meneruskan variabel.
if (isset($_POST['cari'])){
	$cari=$_POST['cari'];
	$sql="select * from dosen where npp like'%$cari%' or
						  namadosen like '%$cari%' or
